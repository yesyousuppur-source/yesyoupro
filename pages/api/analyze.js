...
Return ONLY valid JSON:
{
  ...
  "demand_level": "High",
  "break_even": "Need 45 units/month to break even. Timeline: 2-3 months at current pricing."
}`;

  } else if (mode === "product_scorecard") {
    prompt = `You are an expert Indian ecommerce analyst. Score this product on key metrics:
...
Return ONLY valid JSON:
{
  "overall_score": "72",
  "scores": [
    {"label":"Demand","score":"80"},
    {"label":"Competition","score":"55"},
    {"label":"Margin Potential","score":"70"},
    {"label":"Trend","score":"75"},
    {"label":"Platform Fit","score":"85"},
    {"label":"Scalability","score":"65"}
  ],
  "verdict": "2-3 line overall product assessment",
  "strengths": ["strength1","strength2","strength3"],
  "weaknesses": ["weakness1","weakness2"]
}`;

  } else if (mode === "keyword_research") {
    prompt = `You are an expert in Indian ecommerce SEO and search trends. Find the best keywords for:
...
{
  "keywords": [
    {"keyword":"main keyword 1","volume":"High","competition":"Low"},
    {"keyword":"long tail keyword 2","volume":"Medium","competition":"Low"},
    {"keyword":"keyword 3","volume":"High","competition":"Medium"},
    {"keyword":"keyword 4","volume":"Medium","competition":"Low"},
    {"keyword":"keyword 5","volume":"Low","competition":"Low"},
    {"keyword":"keyword 6","volume":"High","competition":"High"},
    {"keyword":"keyword 7","volume":"Medium","competition":"Medium"},
    {"keyword":"keyword 8","volume":"Low","competition":"Low"}
  ],
  "tip": "One actionable tip to use these keywords effectively on ${platform||"Amazon India"}"
}`;

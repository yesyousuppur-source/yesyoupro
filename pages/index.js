            ...
            <div className="fbox fa">
              ...
              {fpR&&!fpL&&(
                <div style={{marginTop:14}} className="fa">
                  <div style={{background:(parseInt(String(fpR.success_chance||"0").replace(/[^0-9]/g,""))||0)>=60?"rgba(16,185,129,.08)":"rgba(239,68,68,.08)",border:"1px solid rgba(99,102,241,.2)",borderRadius:16,padding:20,textAlign:"center",marginBottom:12}}>
                    <div style={{fontSize:11,color:"#64748b",marginBottom:4,textTransform:"uppercase",letterSpacing:1}}>Success Chance</div>
                    <div style={{fontSize:52,fontWeight:900,lineHeight:1,color:(parseInt(String(fpR.success_chance||"0").replace(/[^0-9]/g,""))||0)>=60?"#10b981":(parseInt(String(fpR.success_chance||"0").replace(/[^0-9]/g,""))||0)>=40?"#f59e0b":"#ef4444"}}>{fpR.success_chance||"N/A"}</div>
                    <div style={{height:8,background:"rgba(255,255,255,.08)",borderRadius:100,margin:"12px 0",overflow:"hidden"}}>
                      <div style={{height:"100%",width:(()=>{const sc=String(fpR.success_chance||"0");return sc.includes("%")?sc:sc+"%";})(),background:"linear-gradient(90deg,#6366f1,#10b981)",borderRadius:100}}/>
                    </div>

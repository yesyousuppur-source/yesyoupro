              ...
              {fpR&&!fpL&&(
                <div style={{marginTop:14}} className="fa">
                  <div style={{background:"rgba(99,102,241,.08)",border:"1px solid rgba(99,102,241,.2)",borderRadius:16,padding:20,textAlign:"center",marginBottom:12}}>
                    ...
                    <div style={{fontSize:52,fontWeight:900,lineHeight:1,color:"#6366f1"}}>{String(fpR.success_chance||"N/A")}</div>
                  ...
                  {fpR.verdict?<div className="gcard" style={{marginBottom:8}}><div className="gct" style={{marginBottom:5}}>Verdict</div><p className="gctx">{String(fpR.verdict)}</p></div>:null}
                  ...
                  {fpR.break_even?<div style={{background:"rgba(99,102,241,.06)",border:"1px solid rgba(99,102,241,.15)",borderRadius:10,padding:11}}><div style={{fontWeight:700,color:"#a5b4fc",fontSize:11,marginBottom:4}}>Break-Even</div><p style={{color:"#94a3b8",fontSize:11,lineHeight:1.65}}>{String(fpR.break_even)}</p></div>:null}
                </div>
              )}
            </div>
          )}
